...
ipv6gen
    ...
    worm[~/IPv6/ipv6gen]> ./ipv6gen.pl 2001:1508:1003::/48 64
    ...
    worm[~/IPv6/ipv6gen]> ./ipv6gen.pl -d -m 2001:1508:1003::/48 53
    ...
    For example, one of the prefixes
    allocated
    by IANA to RIPE NCC is
    ...
    simstim:ipv6gen $ ./ipv6gen.pl -s 8 -r 2001:1400::/23 32
    ...
    list of
    prefixes allocated by RIPE to LIRs to see that this is really the scheme
    RIPE uses.
...
check-overlap
    ...
    worm[~/IPv6/ipv6gen]> ./check-overlap.pl 2001:1508::/32 2001:1508:FFB0:C0::/52
